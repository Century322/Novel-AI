...
export const INTENT_TOOL_MAPPING: Record<IntentCategory, Record<string, string[]>> = {
  creation: {
    write_chapter: ['generate_content', 'file_ops'],
    continue_writing: ['continue_writing'],
    write_outline: ['generate_content', 'file_ops'],
    write_character: ['story_update', 'file_ops'],
    write_worldbuilding: ['file_ops'],
    write_scene: ['generate_content'],
    write_dialogue: ['generate_content'],
  },
  query: {
    get_character_info: ['story_query'],
    get_timeline: ['story_query'],
    get_plot_info: ['file_ops'],
    get_worldbuilding: ['file_ops'],
    search_content: ['file_ops'],
    get_foreshadowing: ['story_query'],
  },
  modification: {
    revise_content: ['generate_content'],
    polish_content: ['generate_content'],
    expand_content: ['generate_content'],
    shorten_content: ['generate_content'],
    change_style: ['generate_content'],
  },
  management: {
    add_character: ['story_update'],
    update_character: ['file_ops'],
    add_plot_event: ['story_update'],
    add_foreshadowing: ['story_update'],
    resolve_foreshadowing: ['file_ops'],
    add_worldbuilding: ['file_ops'],
  },
  analysis: {
    analyze_content: ['story_analysis'],
    analyze_character: ['story_query', 'story_analysis'],
    analyze_plot: ['file_ops', 'story_analysis'],
    analyze_style: ['style_ops'],
    check_consistency: ['file_ops', 'story_analysis'],
  },
  learning: {
    learn_style: ['style_ops'],
    learn_from_reference: ['style_ops'],
    analyze_reference: ['style_ops', 'story_analysis'],
  },
  chat: {
    greeting: [],
    question: [],
